...
Ce changement nous simplifiera le travail.
  ...
  a. Supposez que $b=0$, c'est-à-dire qu'il n'y a pas de frottement. Trouvez la solution particulière dans le cas où $a\neq \omega$. (Vous étudiez dans ce cas la situation des __battements__) Si vous êtes dans la version en ligne de ce document, vous pouvez écouter un battement en utilisant le lecteur ci-contre.
  <audio controls="controls"><source src="resources/sound/beat.wav" type="audio/wav" /></audio>
  a. Supposez que $b=0$, c'est-à-dire qu'il n'y a pas de frottement. Trouvez la solution particulière dans le cas où $a =\omega$. (Vous étudiez dans ce cas la situation de __résonnance__) Pour voir en action le phénomène de résonnance, vous pouvez aller 

```

```{r}
knitr::include_url("https://youtu.be/j-zczJXSxnw")
```
...
Débutons par trouver la solution de l'équation


## GeoGebra {#geogebra-edo}
