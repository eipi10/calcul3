...
{\centering \includegraphics[width=0.5\linewidth]{resources/images/latex/point3d} 
...
La figure \ref{fig:volcano} représente l'information topographique
relative au volcan \emph{Maunga Whau} situé en Nouvelle-Zélande.
...
\caption{Représentation en trois dimensions d'une fonction de deux variables.}\label{fig:volcano}
\end{figure}
...
\caption{Paraboloïde: $x=x^2+y^2$}\label{fig:paraboloide}
\end{figure}
