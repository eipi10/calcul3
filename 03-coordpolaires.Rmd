...
```{theorem,name="Tangentes à une courbe polaire"}
...
```{theorem,name="Logueur d'une courbe en coordonnées polaires"}
...
La longueur d'une courbe en coordonnées polaires définie par $r=f(\theta)$
